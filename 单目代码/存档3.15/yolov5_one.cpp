...
ObjectInfo draw_objects(const cv::Mat& bgr, const std::vector<Object>& objects)
{
    int center_x = 0;
    int center_y = 0;
    int center_label = -1;
    ...
    cv::waitKey(1);
#else
    cv::imwrite("ObjectInfo.jpg", image);
#endif
...
int main(int argc, char** argv){ 
    ...
    while (true)
    {
        ...
        ObjectInfo obj = draw_objects(m, objects);  
